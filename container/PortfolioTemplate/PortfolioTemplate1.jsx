...
export default function PortfolioTemplate1(props) {
    ...
    return (
      ...
      {value.Educations && <Education1 education={value.Educations} />}
      {value.Skills && <Skills1 skills={ value.Skills} />}
      <Box width={'100%'} bgcolor={'#000'}>
          {value.Experiences && <Work1 experiences={value.Experiences} />}
          {value.Projects && <Project1 projects={value.Projects} />}
          {value.Courses && <Courses1 courses={value.Courses} />}
          {value.Awards && <Awards1 awards={value.Awards} />}
          <Contact1 />
          <Hidden smDown>
